  ...
  describe('calculateTotal', () => {
    it('should calculate total correctly for multiple items', () => {
      const items: CartItem[] = [
        { id: '1', menuItemId: 'm1', name: 'Burger', category: 'Main', price: 10, quantity: 2 },
        { id: '2', menuItemId: 'm2', name: 'Fries', category: 'Side', price: 5, quantity: 1 },
      ];
    ...
    it('should handle floating point math correctly', () => {
      const items: CartItem[] = [
        { id: '1', menuItemId: 'm1', name: 'Item A', category: 'Main', price: 1.1, quantity: 3 }, // 3.3
      ];
